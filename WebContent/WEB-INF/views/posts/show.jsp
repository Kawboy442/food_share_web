                ...
                <c:param name="content">
                    <c:choose>
                        <c:when test="${post != null}">
                            <h2>タイトル:
                                <c:out value="${post.title}" />の投稿詳細ページ
                            </h2>
                            <p hidden>"${post.id}"</p>
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                ...
                                                <c:when test="${post.evaluation == 2}"><img src="<c:url value='/images/star_double.png'  />" height=30 />
                                                </c:when>
                                                <c:when test="${post.evaluation == 3}"><img src="<c:url value='/images/star_triple.png'  />" height=30 />
                                                </c:when>
                                                <c:when test="${post.evaluation == 4}"><img src="<c:url value='/images/star_fourfold.png'  />" height=30 />
                                                </c:when>
                                                <c:when test="${post.evaluation == 5}"><img src="<c:url value='/images/star_fivetimes.png'  />" height=30 />
                                                </c:when>
                                            </c:choose>
                                        </td>
                                    </tr>
