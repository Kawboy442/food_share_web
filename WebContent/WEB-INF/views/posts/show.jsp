                                ...
                                <div class="twitter__block">
                                    ...
                                    <div class="twitter__block-text">
                                        ...
                                        <c:if test="${post.photoUrl1 != null}">
                                        	<a href="<c:url value="${post.photoUrl1}" />" data-lightbox="${post.id}"><img src="<c:url value="${post.photoUrl1}" />"></a>
                                        </c:if>
                                        <c:if test="${post.photoUrl2 != null}">
                                        	<a href="<c:url value="${post.photoUrl2}" />" data-lightbox="${post.id}"><img src="<c:url value="${post.photoUrl2}" />"></a>
                                        </c:if>
                                        </div>
                                       </div>
                                    </div>
