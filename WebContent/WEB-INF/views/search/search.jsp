...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
    	<form method="POST" action="<c:url value='/search/result'/>" id="search_form" name="search_form">
			...
			<input type="text" id="store_name" name="store_name" value="${post.store_name}" />
			<br /><br />

			<label for="user_name">ユーザー名</label><br />
			<input type="text" id="user_name" name="user_name" value="${post.user_name}" />
			<br /><br />

			<label for="evaluation">評価</label><br />
			<select name="evaluation" id="evaluation" name="eval">
